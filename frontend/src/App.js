    ...
    <BrowserRouter>
      <div className="grid-container">
        <header className="row">
          ...
          <div>
            ...
            {userInfo ? (
              <div className="dropdown">
                ...
                <ul className="dropdown-content">
                  ...
                  <li>
                    <Link to="/orderhistory">Compras</Link>
                  </li>
                  <li>
            ...
            {userInfo && userInfo.isSeller && (
              <div className="dropdown">
                <Link to="#admin">
                  Vender <i className="fa fa-caret-down"></i>
                </Link>
                <ul className="dropdown-content">
                  <li>
                  ...
                  <li>
                    <Link to="/orderlist/seller">Ventas</Link>
                  </li>
                </ul>
              </div>
            )}
            {userInfo && userInfo.isAdmin && (
              <div className="dropdown">
                ...
                <ul className="dropdown-content">
                  <li>
                    <Link to="/dashboard">Panel general</Link>
                  </li>
                  <li>
        ...
        <footer className="row center">
          Amazon libre ®, 2021. Todos los derechos reservados.
        </footer>
      </div>
    </BrowserRouter>
  );
